...
# Laboratorio 54- Parte 3- Dendrograma circular en R
...
# Para colorear las ramas usamos la funcion color_branches, basandonos en el numero de grupos (k) o en una altura (h). 
# La funcion contiene un argumento llamado col que permite personalizar los colores
hc <- hc %>%
  color_branches(k = 3)
...
# Las etiquetas se pueden personalizar de la misma manera que las ramas. 
# Usamos para ello la funcion color_labels y especifica el numero de grupos o la altura.
hc <- hc %>%
  color_branches(k = 3) %>%
  color_labels(k = 3)
